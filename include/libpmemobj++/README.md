...
A usage of the libpmemobj-cpp containers requires GCC >= 4.9.0 (see explaination
in main README.md file).
...
have a well-known STL-like interface, and they work with STL algorithms.
