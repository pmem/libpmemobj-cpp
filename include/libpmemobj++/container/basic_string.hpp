...
public:
	...
	operator basic_string_view<CharT, Traits>();
 ...
 */
template <typename CharT, typename Traits>
basic_string<CharT, Traits>::operator basic_string_view<CharT, Traits>()
{
	return basic_string_view<CharT, Traits>(data(), length());
}
