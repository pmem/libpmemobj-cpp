...
public:
	...
	basic_inline_string(string_view v);
	basic_inline_string(size_type capacity);
	basic_inline_string(const basic_inline_string<CharT> &rhs);

	basic_inline_string<CharT> &
	operator=(const basic_inline_string<CharT> &rhs);

	basic_inline_string<CharT> &operator=(string_view rhs);

	basic_inline_string(basic_inline_string<CharT> &&) = delete;
	basic_inline_string<CharT> &

	operator=(basic_inline_string<CharT> &&) = delete;
	...
	basic_inline_string<CharT> &assign(string_view rhs);
...
basic_inline_string<CharT, Traits>::basic_inline_string(string_view v)
...
basic_inline_string<CharT, Traits>::basic_inline_string(
	const basic_inline_string<CharT> &rhs)
...
template <typename CharT, typename Traits>
basic_inline_string<CharT> &
basic_inline_string<CharT, Traits>::operator=(string_view rhs)
{
	return assign(rhs);
}
...
template <typename CharT, typename Traits>
basic_inline_string<CharT, Traits>::operator string_view() const
{
	return {data(), size()};
}
...
template <typename CharT, typename Traits>
basic_inline_string<CharT> &
basic_inline_string<CharT, Traits>::assign(string_view rhs)
{
