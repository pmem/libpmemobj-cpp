...
struct root {
	...
	nvobj::persistent_ptr<S> s_arr[14];
};
...
test(int argc, char *argv[])
{
	...
	auto r = pop.root();
	{
		...
		try {
			...
			test(pop, *s_arr[2], *s_arr[1], *s_arr[7]);
			test(pop, *s_arr[2], *s_arr[2], *s_arr[3]);
			test(pop, *s_arr[2], *s_arr[3], *s_arr[8]);

			test(pop, *s_arr[3], *s_arr[0], *s_arr[3]);
			test(pop, *s_arr[3], *s_arr[1], *s_arr[10]);
			test(pop, *s_arr[3], *s_arr[2], *s_arr[8]);
			test(pop, *s_arr[3], *s_arr[3], *s_arr[11]);

			test(pop, *s_arr[12], *s_arr[0], *s_arr[12]);
			test(pop, *s_arr[11], *s_arr[11], *s_arr[12]);
			test(pop, *s_arr[12], *s_arr[1], *s_arr[13]);
