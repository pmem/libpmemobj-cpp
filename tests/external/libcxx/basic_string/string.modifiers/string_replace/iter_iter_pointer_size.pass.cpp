...
test0(nvobj::pool<struct root> &pop)
{
	...
	test(pop, *s_arr[260], 0, 2, "", 0, *s_arr[405]);
	test(pop, *s_arr[260], 0, 2, "12345", 0, *s_arr[405]);
	...
	test(pop, *s_arr[260], 0, 2, "1234567890", 0, *s_arr[405]);
	...
	test(pop, *s_arr[260], 0, 2, "12345678901234567890", 0, *s_arr[405]);
	...
	test(pop, *s_arr[260], 0, 4, "", 0, *s_arr[406]);
	test(pop, *s_arr[260], 0, 4, "12345", 0, *s_arr[406]);
	...
	test(pop, *s_arr[260], 0, 4, "1234567890", 0, *s_arr[406]);
	...
	test(pop, *s_arr[260], 0, 4, "12345678901234567890", 0, *s_arr[406]);
...
test3(nvobj::pool<struct root> &pop)
{
	...
	test(pop, *s_arr[318], 0, 5, "", 0, *s_arr[407]);
	test(pop, *s_arr[318], 0, 5, "12345", 0, *s_arr[407]);
	...
	test(pop, *s_arr[318], 0, 5, "1234567890", 0, *s_arr[407]);
	...
	test(pop, *s_arr[318], 0, 5, "12345678901234567890", 0, *s_arr[407]);
	...
	test(pop, *s_arr[318], 0, 9, "", 0, *s_arr[408]);
	test(pop, *s_arr[318], 0, 9, "12345", 0, *s_arr[408]);
	...
	test(pop, *s_arr[318], 0, 9, "1234567890", 0, *s_arr[408]);
	...
	test(pop, *s_arr[318], 0, 9, "12345678901234567890", 0, *s_arr[408]);
...
test6(nvobj::pool<struct root> &pop)
{
	...
	test(pop, *s_arr[376], 0, 10, "", 0, *s_arr[409]);
	test(pop, *s_arr[376], 0, 10, "12345", 0, *s_arr[409]);
	...
	test(pop, *s_arr[376], 0, 10, "1234567890", 0, *s_arr[409]);
	...
	test(pop, *s_arr[376], 0, 10, "12345678901234567890", 0, *s_arr[409]);
	...
	test(pop, *s_arr[376], 0, 19, "", 0, *s_arr[410]);
	test(pop, *s_arr[376], 0, 19, "12345", 0, *s_arr[410]);
	...
	test(pop, *s_arr[376], 0, 19, "1234567890", 0, *s_arr[410]);
	...
	test(pop, *s_arr[376], 0, 19, "12345678901234567890", 0, *s_arr[410]);
	...
	auto r = pop.root();
	{
		...
		try {
			...
			s_extra_long.replace(
				...
				s_extra_long.data(), s_extra_long.size());
