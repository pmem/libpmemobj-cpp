...
test0(nvobj::pool<struct root> &pop)
{
	...
	test(pop, *s_arr[0], 0, 1, "12345", *s_arr[1]);
	test(pop, *s_arr[0], 0, 1, "1234567890", *s_arr[2]);
	test(pop, *s_arr[0], 0, 1, "12345678901234567890", *s_arr[3]);
	test(pop, *s_arr[0], 1, 0, "", *s_arr[170]);
	test(pop, *s_arr[0], 1, 0, "12345", *s_arr[170]);
	test(pop, *s_arr[0], 1, 0, "1234567890", *s_arr[170]);
	test(pop, *s_arr[0], 1, 0, "12345678901234567890", *s_arr[170]);
	...
	test(pop, *s_arr[100], 0, 2, "", *s_arr[171]);
	...
	test(pop, *s_arr[100], 0, 4, "", *s_arr[172]);
	...
	test(pop, *s_arr[100], 0, 6, "", *s_arr[0]);
	test(pop, *s_arr[100], 0, 6, "12345", *s_arr[1]);
	test(pop, *s_arr[100], 0, 6, "1234567890", *s_arr[2]);
	test(pop, *s_arr[100], 0, 6, "12345678901234567890", *s_arr[3]);
	...
	test(pop, *s_arr[100], 1, 5, "", *s_arr[40]);
	test(pop, *s_arr[100], 1, 5, "12345", *s_arr[41]);
	test(pop, *s_arr[100], 1, 5, "1234567890", *s_arr[42]);
	test(pop, *s_arr[100], 1, 5, "12345678901234567890", *s_arr[43]);
	...
	test(pop, *s_arr[100], 2, 4, "", *s_arr[80]);
	test(pop, *s_arr[100], 2, 4, "12345", *s_arr[81]);
	test(pop, *s_arr[100], 2, 4, "1234567890", *s_arr[82]);
	test(pop, *s_arr[100], 2, 4, "12345678901234567890", *s_arr[83]);
	...
	test(pop, *s_arr[100], 4, 2, "", *s_arr[93]);
	test(pop, *s_arr[100], 4, 2, "12345", *s_arr[94]);
	test(pop, *s_arr[100], 4, 2, "1234567890", *s_arr[95]);
	test(pop, *s_arr[100], 4, 2, "12345678901234567890", *s_arr[96]);
	...
	test(pop, *s_arr[100], 5, 1, "", *s_arr[100]);
	test(pop, *s_arr[100], 5, 1, "12345", *s_arr[101]);
	test(pop, *s_arr[100], 5, 1, "1234567890", *s_arr[102]);
	test(pop, *s_arr[100], 5, 1, "12345678901234567890", *s_arr[103]);
}
...
test1(nvobj::pool<struct root> &pop)
{
	...
	test(pop, *s_arr[100], 6, 0, "", *s_arr[170]);
	test(pop, *s_arr[100], 6, 0, "12345", *s_arr[170]);
	test(pop, *s_arr[100], 6, 0, "1234567890", *s_arr[170]);
	test(pop, *s_arr[100], 6, 0, "12345678901234567890", *s_arr[170]);
	...
	test(pop, *s_arr[123], 0, 5, "", *s_arr[173]);
	...
	test(pop, *s_arr[123], 0, 9, "", *s_arr[174]);
	...
	test(pop, *s_arr[123], 0, 11, "", *s_arr[0]);
	test(pop, *s_arr[123], 0, 11, "12345", *s_arr[1]);
	test(pop, *s_arr[123], 0, 11, "1234567890", *s_arr[2]);
	test(pop, *s_arr[123], 0, 11, "12345678901234567890", *s_arr[3]);
	...
	test(pop, *s_arr[123], 1, 10, "", *s_arr[40]);
	test(pop, *s_arr[123], 1, 10, "12345", *s_arr[41]);
	test(pop, *s_arr[123], 1, 10, "1234567890", *s_arr[42]);
	test(pop, *s_arr[123], 1, 10, "12345678901234567890", *s_arr[43]);
	...
	test(pop, *s_arr[123], 5, 6, "", *s_arr[100]);
	test(pop, *s_arr[123], 5, 6, "12345", *s_arr[101]);
	test(pop, *s_arr[123], 5, 6, "1234567890", *s_arr[102]);
	test(pop, *s_arr[123], 5, 6, "12345678901234567890", *s_arr[103]);
	...
	test(pop, *s_arr[123], 9, 2, "", *s_arr[116]);
	test(pop, *s_arr[123], 9, 2, "12345", *s_arr[117]);
	test(pop, *s_arr[123], 9, 2, "1234567890", *s_arr[118]);
	test(pop, *s_arr[123], 9, 2, "12345678901234567890", *s_arr[119]);
	...
	test(pop, *s_arr[123], 10, 1, "", *s_arr[123]);
	test(pop, *s_arr[123], 10, 1, "12345", *s_arr[124]);
	test(pop, *s_arr[123], 10, 1, "1234567890", *s_arr[125]);
	test(pop, *s_arr[123], 10, 1, "12345678901234567890", *s_arr[126]);
	test(pop, *s_arr[123], 11, 0, "", *s_arr[170]);
	test(pop, *s_arr[123], 11, 0, "12345", *s_arr[170]);
	test(pop, *s_arr[123], 11, 0, "1234567890", *s_arr[170]);
	test(pop, *s_arr[123], 11, 0, "12345678901234567890", *s_arr[170]);
}
...
test2(nvobj::pool<struct root> &pop)
{
	...
	test(pop, *s_arr[146], 0, 10, "", *s_arr[175]);
	...
	test(pop, *s_arr[146], 0, 19, "", *s_arr[176]);
	...
	test(pop, *s_arr[146], 0, 21, "", *s_arr[0]);
	test(pop, *s_arr[146], 0, 21, "12345", *s_arr[1]);
	test(pop, *s_arr[146], 0, 21, "1234567890", *s_arr[2]);
	test(pop, *s_arr[146], 0, 21, "12345678901234567890", *s_arr[3]);
	...
	test(pop, *s_arr[146], 1, 20, "", *s_arr[40]);
	test(pop, *s_arr[146], 1, 20, "12345", *s_arr[41]);
	test(pop, *s_arr[146], 1, 20, "1234567890", *s_arr[42]);
	test(pop, *s_arr[146], 1, 20, "12345678901234567890", *s_arr[43]);
	...
	test(pop, *s_arr[146], 10, 11, "", *s_arr[123]);
	test(pop, *s_arr[146], 10, 11, "12345", *s_arr[124]);
	test(pop, *s_arr[146], 10, 11, "1234567890", *s_arr[125]);
	test(pop, *s_arr[146], 10, 11, "12345678901234567890", *s_arr[126]);
	...
	test(pop, *s_arr[146], 19, 2, "", *s_arr[139]);
	test(pop, *s_arr[146], 19, 2, "12345", *s_arr[140]);
	test(pop, *s_arr[146], 19, 2, "1234567890", *s_arr[141]);
	test(pop, *s_arr[146], 19, 2, "12345678901234567890", *s_arr[142]);
	...
	test(pop, *s_arr[146], 20, 1, "", *s_arr[146]);
	test(pop, *s_arr[146], 20, 1, "12345", *s_arr[147]);
	test(pop, *s_arr[146], 20, 1, "1234567890", *s_arr[148]);
	test(pop, *s_arr[146], 20, 1, "12345678901234567890", *s_arr[149]);
	test(pop, *s_arr[146], 21, 0, "", *s_arr[170]);
	test(pop, *s_arr[146], 21, 0, "12345", *s_arr[170]);
	test(pop, *s_arr[146], 21, 0, "1234567890", *s_arr[170]);
	test(pop, *s_arr[146], 21, 0, "12345678901234567890", *s_arr[170]);
}
