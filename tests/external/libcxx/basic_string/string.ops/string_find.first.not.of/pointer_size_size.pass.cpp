...
{
	UT_ASSERT(s.find_first_not_of(str, pos, n) == x);
	if (x != S::npos)
...
test0(nvobj::pool<struct root> &pop)
{
	...
	test(*s_arr[144], "joflqbdkhtegimscpanr", 1, 10, 3);
	...
	test(*s_arr[50], "tpdrchmkji", 2, 5, 3);
	test(*s_arr[125], "ijagfkblst", 2, 9, 3);
	...
	test(*s_arr[124], "jfmpr", 4, 5, S::npos);
	test(*s_arr[158], "rbpefghsmj", 4, 0, 4);
	test(*s_arr[227], "apsfntdoqc", 4, 1, 4);
	test(*s_arr[280], "ndkjeisgcl", 4, 5, 4);
	test(*s_arr[199], "rnfpqatdeo", 4, 9, S::npos);
	test(*s_arr[145], "bntjlqrfik", 4, 10, S::npos);
	test(*s_arr[201], "kcrtmpolnaqejghsfdbi", 4, 0, 4);
	test(*s_arr[202], "lobheanpkmqidsrtcfgj", 4, 1, 4);
	test(*s_arr[266], "athdkljcnreqbgpmisof", 4, 10, S::npos);
	test(*s_arr[52], "qkdmjialrscpbhefgont", 4, 19, S::npos);
...
test1(nvobj::pool<struct root> &pop)
{
	...
	test(*s_arr[97], "skqne", 5, 4, S::npos);
	test(*s_arr[168], "kipnf", 5, 5, S::npos);
	test(*s_arr[172], "hmrnqdgifl", 5, 0, S::npos);
	test(*s_arr[69], "fsmjcdairn", 5, 1, S::npos);
	test(*s_arr[10], "pcdgltbrfj", 5, 5, S::npos);
	test(*s_arr[32], "aekfctpirg", 5, 9, S::npos);
	test(*s_arr[143], "ledihrsgpf", 5, 10, S::npos);
	test(*s_arr[30], "mqcklahsbtirgopefndj", 5, 0, S::npos);
	test(*s_arr[87], "kmlthaoqgecrnpdbjfis", 5, 1, S::npos);
	test(*s_arr[71], "sfhbamcdptojlkrenqgi", 5, 10, S::npos);
	test(*s_arr[167], "pbniofmcedrkhlstgaqj", 5, 19, S::npos);
	...
	test(*s_arr[162], "ohcmb", 6, 4, S::npos);
	test(*s_arr[19], "heatr", 6, 5, S::npos);
	test(*s_arr[178], "pmblckedfn", 6, 0, S::npos);
	test(*s_arr[197], "aceqmsrbik", 6, 1, S::npos);
	test(*s_arr[56], "lmbtdehjrn", 6, 5, S::npos);
	test(*s_arr[155], "teqmcrlgib", 6, 9, S::npos);
	test(*s_arr[142], "njolbmspac", 6, 10, S::npos);
	test(*s_arr[244], "pofnhidklamecrbqjgst", 6, 0, S::npos);
	test(*s_arr[261], "jbhckmtgrqnosafedpli", 6, 1, S::npos);
	test(*s_arr[103], "dobntpmqklicsahgjerf", 6, 10, S::npos);
	...
	test(*s_arr[224], "qcpjibosfl", 0, 5, 2);
	test(*s_arr[256], "lrhmefnjcq", 0, 9, 4);
	...
	test(*s_arr[134], "jplqg", 9, 5, S::npos);
	test(*s_arr[78], "oilnrbcgtj", 9, 0, 9);
	test(*s_arr[84], "morkglpesn", 9, 1, 9);
	test(*s_arr[82], "dmicerngat", 9, 5, S::npos);
	...
	test(*s_arr[49], "spqfoiclmtagejbndkrh", 9, 19, S::npos);
	test(*s_arr[54], "nmotklspigjrdhcfaebq", 9, 20, S::npos);
	test(*s_arr[200], "", 10, 0, S::npos);
	test(*s_arr[117], "hpmsd", 10, 0, S::npos);
	test(*s_arr[233], "qnpor", 10, 1, S::npos);
	test(*s_arr[107], "otdma", 10, 2, S::npos);
	test(*s_arr[35], "efhjg", 10, 4, S::npos);
	test(*s_arr[16], "odpte", 10, 5, S::npos);
	test(*s_arr[3], "bctdgfmolr", 10, 0, S::npos);
	test(*s_arr[137], "oaklidrbqg", 10, 1, S::npos);
}
...
test2(nvobj::pool<struct root> &pop)
{
	...
	test(*s_arr[265], "dnjfsagktr", 10, 5, S::npos);
	test(*s_arr[111], "nejaktmiqg", 10, 9, S::npos);
	test(*s_arr[21], "pjqonlebsf", 10, 10, S::npos);
	test(*s_arr[80], "dshmnbtolcjepgaikfqr", 10, 0, S::npos);
	test(*s_arr[260], "iogfhpabtjkqlrnemcds", 10, 1, S::npos);
	test(*s_arr[154], "ngridfabjsecpqltkmoh", 10, 10, S::npos);
	test(*s_arr[267], "athmknplcgofrqejsdib", 10, 19, S::npos);
	test(*s_arr[240], "ldobhmqcafnjtkeisgrp", 10, 20, S::npos);
	test(*s_arr[45], "", 11, 0, S::npos);
	test(*s_arr[123], "aocjb", 11, 0, S::npos);
	test(*s_arr[282], "jbrnk", 11, 1, S::npos);
	test(*s_arr[206], "tqedg", 11, 2, S::npos);
	test(*s_arr[248], "nqskp", 11, 4, S::npos);
	test(*s_arr[239], "eaqkl", 11, 5, S::npos);
	test(*s_arr[122], "reaoicljqm", 11, 0, S::npos);
	test(*s_arr[118], "lsftgajqpm", 11, 1, S::npos);
	test(*s_arr[214], "rlpfogmits", 11, 5, S::npos);
	test(*s_arr[152], "shkncmiaqj", 11, 9, S::npos);
	test(*s_arr[252], "fpnatrhqgs", 11, 10, S::npos);
	test(*s_arr[277], "sjclemqhnpdbgikarfot", 11, 0, S::npos);
	test(*s_arr[179], "otcmedjikgsfnqbrhpla", 11, 1, S::npos);
	test(*s_arr[39], "bonsaefdqiprkhlgtjcm", 11, 10, S::npos);
	...
	test(*s_arr[165], "eqbdrkcfah", 10, 9, 11);
	test(*s_arr[153], "kapmsienhf", 10, 10, 10);
	test(*s_arr[190], "jpqotrlenfcsbhkaimdg", 10, 0, 10);
	test(*s_arr[8], "jlbmhnfgtcqprikeados", 10, 1, 10);
	test(*s_arr[131], "stgbhfmdaljnpqoicker", 10, 10, 11);
	test(*s_arr[41], "oihcetflbjagdsrkmqpn", 10, 19, 11);
	...
	test(*s_arr[157], "dtcoj", 19, 5, S::npos);
	...
	test(*s_arr[262], "nlmcjaqgbsortfdihkpe", 19, 10, S::npos);
	test(*s_arr[231], "racfnpmosldibqkghjet", 19, 19, S::npos);
	test(*s_arr[213], "fjhdsctkqeiolagrnmbp", 19, 20, S::npos);
	test(*s_arr[250], "", 20, 0, S::npos);
	test(*s_arr[216], "ejanp", 20, 0, S::npos);
	test(*s_arr[110], "odife", 20, 1, S::npos);
	test(*s_arr[146], "okaqd", 20, 2, S::npos);
	test(*s_arr[101], "lcdbi", 20, 4, S::npos);
	test(*s_arr[22], "fsqbj", 20, 5, S::npos);
	test(*s_arr[204], "bigdomnplq", 20, 0, S::npos);
	test(*s_arr[91], "apiblotgcd", 20, 1, S::npos);
	test(*s_arr[253], "acfhdenops", 20, 5, S::npos);
	test(*s_arr[247], "jopdeamcrk", 20, 9, S::npos);
	test(*s_arr[81], "trqncbkgmh", 20, 10, S::npos);
...
test3(nvobj::pool<struct root> &pop)
{
	...
	test(*s_arr[222], "gbkhdnpoietfcmrslajq", 20, 1, S::npos);
	test(*s_arr[161], "rtfnmbsglkjaichoqedp", 20, 10, S::npos);
	test(*s_arr[270], "ohkmdpfqbsacrtjnlgei", 20, 19, S::npos);
	test(*s_arr[254], "dlbrteoisgphmkncajfq", 20, 20, S::npos);
	test(*s_arr[65], "", 21, 0, S::npos);
	test(*s_arr[83], "sjrlo", 21, 0, S::npos);
	test(*s_arr[255], "qjpor", 21, 1, S::npos);
	test(*s_arr[109], "odhfn", 21, 2, S::npos);
	test(*s_arr[264], "qtfin", 21, 4, S::npos);
	test(*s_arr[191], "hpqfo", 21, 5, S::npos);
	test(*s_arr[217], "fabmertkos", 21, 0, S::npos);
	test(*s_arr[263], "brqtgkmaej", 21, 1, S::npos);
	test(*s_arr[53], "nfrdeihsgl", 21, 5, S::npos);
	test(*s_arr[5], "hlfrosekpi", 21, 9, S::npos);
	test(*s_arr[112], "atgbkrjdsm", 21, 10, S::npos);
	test(*s_arr[223], "blnrptjgqmaifsdkhoec", 21, 0, S::npos);
	test(*s_arr[242], "ctpmdahebfqjgknloris", 21, 1, S::npos);
	test(*s_arr[237], "apnkeqthrmlbfodiscgj", 21, 10, S::npos);
	test(*s_arr[166], "jdgictpframeoqlsbknh", 21, 19, S::npos);
