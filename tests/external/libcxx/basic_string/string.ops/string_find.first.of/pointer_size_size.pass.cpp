...
{
	UT_ASSERT(s.find_first_of(str, pos, n) == x);
	if (x != S::npos)
...
test0(nvobj::pool<struct root> &pop)
{
	...
	test(*s_arr[185], "pqscrjthli", 0, 10, 1);
	...
	test(*s_arr[164], "lasiq", 1, 4, 2);
	test(*s_arr[281], "kfqmr", 1, 5, S::npos);
	test(*s_arr[136], "klnitfaobg", 1, 0, S::npos);
	test(*s_arr[148], "gjhmdlqikp", 1, 1, 3);
	test(*s_arr[100], "skbgtahqej", 1, 5, S::npos);
	test(*s_arr[58], "bjsdgtlpkf", 1, 9, 2);
	test(*s_arr[28], "bjgfmnlkio", 1, 10, 4);
	...
	test(*s_arr[274], "dpifl", 2, 2, 4);
	test(*s_arr[115], "oapht", 2, 4, S::npos);
	test(*s_arr[212], "cifts", 2, 5, 3);
	...
	test(*s_arr[280], "ndkjeisgcl", 4, 5, S::npos);
...
test1(nvobj::pool<struct root> &pop)
{
	...
	test(*s_arr[23], "dashm", 0, 1, 8);
	test(*s_arr[273], "jqirk", 0, 2, 8);
	test(*s_arr[149], "rckeg", 0, 4, 1);
	test(*s_arr[102], "jscie", 0, 5, 3);
	test(*s_arr[132], "efsphndliq", 0, 0, S::npos);
	test(*s_arr[135], "gdicosleja", 0, 1, 5);
	test(*s_arr[224], "qcpjibosfl", 0, 5, 0);
	test(*s_arr[256], "lrhmefnjcq", 0, 9, 0);
	test(*s_arr[139], "dtablcrseo", 0, 10, 1);
	test(*s_arr[272], "apckjsftedbhgomrnilq", 0, 0, S::npos);
	test(*s_arr[278], "pcbrgflehjtiadnsokqm", 0, 1, S::npos);
	test(*s_arr[259], "nsiadegjklhobrmtqcpf", 0, 10, 4);
	...
	test(*s_arr[218], "gbkqdoeftl", 1, 9, 4);
	...
	test(*s_arr[11], "qcloh", 5, 2, 6);
	test(*s_arr[88], "thlmp", 5, 4, S::npos);
	test(*s_arr[75], "qidmo", 5, 5, 6);
	test(*s_arr[7], "lnegpsjqrd", 5, 0, S::npos);
	test(*s_arr[9], "rjqdablmfs", 5, 1, 5);
	test(*s_arr[133], "enkgpbsjaq", 5, 5, 7);
	test(*s_arr[42], "kdsgoaijfh", 5, 9, 5);
	test(*s_arr[141], "trfqgmckbe", 5, 10, S::npos);
	...
	test(*s_arr[205], "iqfkm", 9, 2, S::npos);
	test(*s_arr[246], "tqjsr", 9, 4, S::npos);
	test(*s_arr[134], "jplqg", 9, 5, 9);
	test(*s_arr[78], "oilnrbcgtj", 9, 0, S::npos);
	test(*s_arr[84], "morkglpesn", 9, 1, S::npos);
	test(*s_arr[82], "dmicerngat", 9, 5, 9);
	test(*s_arr[182], "radgeskbtc", 9, 9, S::npos);
	test(*s_arr[193], "ljikprsmqo", 9, 10, S::npos);
	test(*s_arr[6], "trqihkcgsjamfdbolnpe", 9, 0, S::npos);
	test(*s_arr[17], "lqmthbsrekajgnofcipd", 9, 1, S::npos);
	test(*s_arr[225], "jtalmedribkgqsopcnfh", 9, 10, S::npos);
...
test2(nvobj::pool<struct root> &pop)
{
	...
	test(*s_arr[245], "fjcqh", 0, 1, 4);
	test(*s_arr[37], "fmosa", 0, 2, 3);
	test(*s_arr[207], "qdbok", 0, 4, 3);
	test(*s_arr[63], "amslg", 0, 5, 3);
	test(*s_arr[174], "smpltjneqb", 0, 0, S::npos);
	test(*s_arr[198], "flitskrnge", 0, 1, 19);
	test(*s_arr[34], "pgqihmlbef", 0, 5, 2);
	test(*s_arr[187], "cfpdqjtgsb", 0, 9, 2);
	test(*s_arr[33], "htpsiaflom", 0, 10, 2);
	test(*s_arr[211], "kpjfiaceghsrdtlbnomq", 0, 0, S::npos);
	test(*s_arr[208], "qhtbomidljgafneksprc", 0, 1, 16);
	test(*s_arr[51], "nhtjobkcefldimpsaqgr", 0, 10, 1);
	...
	test(*s_arr[192], "cahif", 10, 1, 12);
	test(*s_arr[98], "kehis", 10, 2, S::npos);
	test(*s_arr[106], "kdlmh", 10, 4, 10);
	test(*s_arr[230], "paeql", 10, 5, 15);
	test(*s_arr[4], "aghoqiefnb", 10, 0, S::npos);
	test(*s_arr[196], "jrbqaikpdo", 10, 1, S::npos);
	test(*s_arr[234], "smjonaeqcl", 10, 5, 11);
	test(*s_arr[165], "eqbdrkcfah", 10, 9, 10);
	test(*s_arr[153], "kapmsienhf", 10, 10, 11);
	test(*s_arr[190], "jpqotrlenfcsbhkaimdg", 10, 0, S::npos);
	test(*s_arr[8], "jlbmhnfgtcqprikeados", 10, 1, 18);
	...
	test(*s_arr[257], "iclat", 19, 1, S::npos);
	test(*s_arr[184], "rkhnf", 19, 2, S::npos);
	test(*s_arr[44], "clshq", 19, 4, S::npos);
	test(*s_arr[157], "dtcoj", 19, 5, 19);
	test(*s_arr[72], "rqosnjmfth", 19, 0, S::npos);
	test(*s_arr[1], "siatdfqglh", 19, 1, S::npos);
	test(*s_arr[238], "mrlshtpgjq", 19, 5, S::npos);
	test(*s_arr[2], "adlcskgqjt", 19, 9, S::npos);
	test(*s_arr[129], "drshcjknaf", 19, 10, S::npos);
	test(*s_arr[195], "etsaqroinghpkjdlfcbm", 19, 0, S::npos);
	test(*s_arr[189], "sgepdnkqliambtrocfhj", 19, 1, S::npos);
