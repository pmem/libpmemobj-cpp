...
test0(nvobj::pool<struct root> &pop)
{
	...
	test(*s_arr[128], *s_arr[26], 0, 1);
	test(*s_arr[19], *s_arr[61], 0, 2);
	...
	test(*s_arr[84], *s_arr[107], 2, 4);
	test(*s_arr[133], *s_arr[75], 2, 2);
	test(*s_arr[122], *s_arr[1], 2, 2);
	test(*s_arr[42], *s_arr[0], 4, S::npos);
	test(*s_arr[72], *s_arr[5], 4, S::npos);
	test(*s_arr[117], *s_arr[118], 4, S::npos);
	...
	test(*s_arr[33], *s_arr[77], 9, S::npos);
	...
	test(*s_arr[20], *s_arr[29], 19, S::npos);
...
test1(nvobj::pool<struct root> &pop)
{
	...
	test(*s_arr[48], *s_arr[71], 0);
	test(*s_arr[105], *s_arr[110], 0);
	test(*s_arr[36], *s_arr[0], S::npos);
	test(*s_arr[99], *s_arr[15], 0);
	test(*s_arr[65], *s_arr[69], 0);
	test(*s_arr[55], *s_arr[115], 0);
	test(*s_arr[50], *s_arr[0], S::npos);
	test(*s_arr[129], *s_arr[13], 1);
	test(*s_arr[123], *s_arr[54], 0);
	test(*s_arr[124], *s_arr[59], 0);
}
