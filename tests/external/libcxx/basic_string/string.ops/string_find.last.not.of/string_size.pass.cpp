...
test1(nvobj::pool<struct root> &pop)
{
	...
	test(*s_arr[101], *s_arr[0], 4);
	test(*s_arr[79], *s_arr[64], 4);
	test(*s_arr[48], *s_arr[71], 4);
	test(*s_arr[105], *s_arr[110], S::npos);
	test(*s_arr[36], *s_arr[0], 9);
	test(*s_arr[99], *s_arr[15], 8);
	test(*s_arr[65], *s_arr[69], 9);
	test(*s_arr[55], *s_arr[115], S::npos);
	test(*s_arr[50], *s_arr[0], 19);
	test(*s_arr[129], *s_arr[13], 18);
	test(*s_arr[123], *s_arr[54], 17);
